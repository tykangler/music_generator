...
from .midi import transform, tokenizer, vocabulary
...
# combine with _tokenize_and_split
...
def _create_dataset(filenames: list, inp_len: int, tar_len: int,
   ...
   midi_tokenizer = tokenizer.MidiTokenizer(all_tokens, default_decoded=vocabulary.rest_0())
   midi_ds = (midi_ds
